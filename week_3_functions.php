...
<form action="week-3-test-2.php" method="GET">
...
<div><?php 
 ...
 $g = '<form action="week-3-test-2.php" method="GET">
...
$h = '<form action="week-3-test-2.php" method="GET">
...
$j = '<form action="week-3-test-2.php" method="GET">
  
<input type="submit" style="background-color: #4CAF50;" name="count" value="count"><input type="submit" style="background-color: #4CAF50;" name="in_array" value="in_array"><input type="submit"  name="SERVER1" value=" $_SERVER">
</form>';
$k = '<form action="week-3-test-2.php" method="GET">
